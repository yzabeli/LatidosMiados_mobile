...
Este guia irá te ajudar a configurar e rodar o projeto mobile do Latidos e Miados na sua máquina local.
...
```bash
git clone https://github.com/monosodrac/LatidosMiados_mobile
```
...
npx expo start
```
- Siga as instruções de comandos no terminal para a execução, variando a instrução dependendo da plataforma utilizada

---

## Opcional

- Faça o clone do repositório e inclua-o no mesmo diretório, para acessar o backend do projeto
  [Acesse aqui](https://github.com/monosodrac/LatidosMiados_backend)
